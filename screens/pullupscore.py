...
class WorkoutScreen(QWidget):
    def __init__(self, exercise_name="Pull up",menu_ref=None):
        super().__init__()
        ...
        self.cap = cv2.VideoCapture("D:\\codekarma\\projects\\wotracker\\assets\\This_is_what_FULL_PULL-UPS_look_like_720P (1).mp4")
