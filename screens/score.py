...
class WorkoutScreen(QWidget):
    ...
    def update_frame(self):
        ...
        #  Process frame, get stats back
        annotated_frame, reps, stage, bar_value = process_frame(frame)

        #  Update left panel
        self.update_stats(reps, stage, bar_value)

        #  Show in Qt window (NO cv2.imshow needed!)
    ...
    # CALL THIS FROM YOUR POSE CODE 
    def update_stats(self, rep_count, position, bar_value=0):
